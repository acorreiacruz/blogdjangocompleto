...
def register(request):
    ...
    return render(request, 'autores/pages/register_view.html', context={
        'form': form,
...
def login_validate(request):
    ...
    if form.is_valid():
        ...
        if authenticated_user is not None:
            ...
            messages.error("Credenciais não autenticadas!")

    else:
        messages.error("Nome de usuário ou senha inválidos, insira os campos novamente!")
